...
class AccessTokenResource : AccessTokenResource<AccessTokenCreateRequest>(AccessTokenCreateOperation::class) {
    fun create(
        userName: String,
        password: String,
        then: ValidatableResponse.() -> Unit = ThenCompletedWithNonNullAccessToken(),
        extract: ExtractableResponse<Response>.() -> String = ExtractAccessToken(),
    ): String {
        return create(
